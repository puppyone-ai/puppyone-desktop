...
| `electron/main/agent/runtimes/opencode/opencode-http-client.mjs` | `packages/sdk/js/src/v2/client.ts`, `packages/sdk/js/src/v2/gen/**`, `packages/opencode/src/server/routes/**` | Uses the exact-version official generated SDK client behind a PuppyOne-owned loopback/origin/operation allowlist, timeout, redirect denial and response/SSE limits; no SDK server helper or generic HTTP proxy. |

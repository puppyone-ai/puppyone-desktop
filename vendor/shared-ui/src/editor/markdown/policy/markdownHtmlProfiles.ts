 ...
 */
export const MARKDOWN_HTML_PROFILE_VERSION = "2026-07-10.1" as const;
...
const SAFE_MEDIA_TAGS = ["img", "audio", "video", "source"] as const;
  ...
  "safe-media": {
    ...
    attributes: {
      ...
      byTag: new Map<string, Set<string>>([
        ...
        ["audio", new Set(["aria-label", "class", "controls", "id", "preload", "src", "title"])],
        ["video", new Set(["aria-label", "class", "controls", "height", "id", "preload", "src", "title", "width"])],

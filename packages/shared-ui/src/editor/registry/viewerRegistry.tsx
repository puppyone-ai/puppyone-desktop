...
import { AppPreviewViewer } from "../viewers/app/AppPreviewViewer";
import { JsonViewer, TextFileViewer } from "../viewers/code/CodeViewer";
import { CsvViewer } from "../viewers/csv/CsvViewer";
import { DocumentPreview } from "../viewers/fallback/DocumentFallbackViewer";
import { HtmlViewer } from "../viewers/html/HtmlViewer";
import {
  AudioResourceViewer,
  ImageResourceViewer,
  VideoResourceViewer,
} from "../viewers/media/ResourceViewers";
import { formatJson } from "../viewers/shared/viewerUtils";
...
const PRESET_VIEWER_DEFINITIONS: PresetViewerContribution[] = [
  ...
  definePresetViewer({
    ...
    isEditable: () => true,
    load: () => import("../markdown/MarkdownViewer").then(({ MarkdownViewer }) => ({
  ...
  definePresetViewer({
    ...
    isEditable: () => true,
    load: () => import("../viewers/puppyflow/PuppyFlowViewer").then(({ PuppyFlowViewer }) => ({
  ...
  definePresetViewer({
    ...
    load: () => import("../viewers/pdf/PdfViewer").then(({ PdfResourceViewer }) => ({
  ...
  definePresetViewer({
    ...
    load: () => import("../viewers/office/OfficeViewer").then(({ OfficeViewer }) => ({

...
Status: implemented normative contract. Acquisition, immutable staging,
capability preflight, transport mapping and committed reference replay are
wired end to end.
...
- Claude Agent may supply authorized workspace paths through its prompt/session

...
import { formatAgentTurnDuration } from "../src/features/desktop-agent/ui/AgentTurnSummary";
...
describe("Desktop Agent renderer surfaces", () => {
  ...
  it("renders one muted duration summary after a terminal Agent turn", () => {
    ...
    expect(formatAgentTurnDuration(999)).toBe("<1s");
    expect(formatAgentTurnDuration(11_431_000)).toBe("3h 10m 31s");
  });

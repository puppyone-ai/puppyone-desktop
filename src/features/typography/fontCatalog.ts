...
export const BUILTIN_FONT_CATALOG = [
  {
    ...
    family: "\"Geist Sans\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans CJK SC\", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    source: "bundled",
    roles: ["ui", "content"],
  },
  {
    ...
    family: "ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans CJK SC\", \"Segoe UI\", sans-serif",
    source: "system",
    roles: ["ui", "content"],
  },
  {

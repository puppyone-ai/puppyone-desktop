...
export type CloudMessageCode =
  ...
  | "binding-confirm-legacy"
  | "binding-confirm-workspace"
  | "binding-wrong-host"
  | "binding-checkout-mismatch"
  | "binding-response-mismatch"
  | "binding-switch-account"
  | "binding-forbidden"
  | "binding-not-authorized"
  | "binding-unresolvable"
  | "binding-network-failed"
  | "binding-unknown-remote"
  | "binding-locator-conflict"
  | "binding-remote-conflict"

...
function readQuestions(value: unknown): AgentQuestionPrompt[] {
...
function pickUsage(payload: Record<string, unknown>) {
...
function pickSafeActivityDetail(payload: Record<string, unknown>) {

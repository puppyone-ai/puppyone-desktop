  ...
  return (
    <header className="desktop-agent-session-header">
      ...
      <div className="desktop-agent-session-header-actions" ref={menuRef}>
        <button type="button" className="desktop-agent-icon-button" aria-label={`New ${runtimeLabel} session`} title={`New ${runtimeLabel} session`} disabled={loading || newSessionDisabled} onClick={onNewSession}><Plus size={16} /></button>

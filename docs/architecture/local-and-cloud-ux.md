...
type ProjectContextResolution =
  ...
  | {
      status: "resolved";
      source: "workspace-binding" | "canonical-remote";
      projectId: string;
      scopeId: string;
      bindingKind: "full" | "scoped";
      bindingId: string | null;
      bindingStatus: "bound" | "not-bound" | "needs-repair";
      capabilities: string[];
    }
  | { status: "local-only" }
  | {
...
| --- | --- | --- |
| Desktop | remote-set normalization, resolution state machine, contextual routing, data-hook separation, recovery/local-only UX, stale-request protection | local filesystem and Git authority |

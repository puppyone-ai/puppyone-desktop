...
visibility, spacing, typography and color.
...
is the only invitation to act, and its ready/empty textarea has no visible
placeholder; its accessible name remains available to assistive technology.

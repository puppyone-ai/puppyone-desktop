...
Level 5  production security/live-recovery/approval contract accepted
...
visible and selectable for inspection, but cannot Send until they meet that
tested protocol baseline.
...
Level 5  permission/live-recovery contract accepted
...
Level 5  production security/live-recovery adapter accepted
